%\documentclass[preprint,aps,epsf,epsfig,cite,tighten,amsfonts]{revtex4}
...
{\bf Maxim Pospelov}$^{1,3}$%\footnote{pospelov@uvic.ca}
\ and
...
as 
\be
{\cal L}_{\rm EDM} = \fr{-i}{2}d_{\rm CP}\bar \psi \sigma^{\mu\nu}F_{\mu\nu} \psi 
...
\be
b^i_d \sim (10^{-19}-10^{-18})\times \fr{1~{\rm GeV}^2}{\Lambda_{\rm CPT}},
\label{bdi}
\ee
...
\bibitem{BGNP} S.~Groot Nibbelink and M.~Pospelov,
